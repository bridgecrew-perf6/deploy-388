...
(function () {
    ...
    function V(a, b, c) {
        var d, e;
        if (Oa(b))t(c) ?
            a.setAttribute(b, c) : a && a.getAttribute && (e = a.getAttribute(b)); else if (t(b) && ea(b))for (d in b)a.setAttribute(d, b[d]);
        return e
    }
    ...
    function E(a, b) {
        if (Ha && !ba && b && b.opacity !== r)b.filter = "alpha(opacity=" + b.opacity * 100 + ")";
        v(a.style, b)
    }
    ...
    function Y(a, b, c, d, e) {
        a = B.createElement(a);
        b && v(a, b);
        e && E(a, {padding: 0, border: X, margin: 0});
        c && E(a, c);
        d && d.appendChild(a);
        return a
    }
    ...
    function Ia(a, b, c, d) {
        var e = I.lang, a = +a || 0, f = b === -1 ? (a.toString().split(".")[1] || "").length : isNaN(b = N(b)) ? 2 : b, b = c === void 0 ? e.decimalPoint : c, d = d === void 0 ? e.thousandsSep : d, e = a < 0 ? "-" : "", c = String(J(a = N(a).toFixed(f))), g = c.length > 3 ? c.length % 3 : 0;
    ...
    function Ja(a, b) {
        for (var c = "{", d = !1, e, f, g, h, i, k = []; (c = a.indexOf(c)) !== -1;) {
            ...
            if (d) {
                ...
                if (f.length)f = f.join(":"), g = /\.([0-9])/, h = I.lang, i = void 0, /f$/.test(f) ? (i = (i = f.match(g)) ? i[1] : -1, e !== null && (e = Ia(e, i, h.decimalPoint, f.indexOf(",") > -1 ? h.thousandsSep : ""))) : e = ua(f, e)
            }
            k.push(e);
            a = a.slice(c + 1);
            c = (d = !d) ?
    ...
    function Mb() {
        var a =
            I.global.useUTC, b = a ? "getUTC" : "get", c = a ? "setUTC" : "set";
        La = (a && I.global.timezoneOffset || 0) * 6E4;
    ...
    var r, B = document, W = window, U = Math, s = U.round, S = U.floor, Va = U.ceil, w = U.max, z = U.min, N = U.abs, ca = U.cos, ha = U.sin, qa = U.PI, Ma = qa * 2 / 360, Da = navigator.userAgent, Sb = W.opera, Ha = /msie/i.test(Da) && !Sb, lb = B.documentMode === 8, mb = /AppleWebKit/.test(Da),
        $a = /Firefox/.test(Da), db = /(Mobile|Android|Windows Phone)/.test(Da), Ea = "http://www.w3.org/2000/svg", ba = !!B.createElementNS && !!B.createElementNS(Ea, "svg").createSVGRect, Yb = $a && parseInt(Da.split("Firefox/")[1], 10) < 4, ia = !ba && !Ha && !!B.createElement("canvas").getContext, Wa, ab, Tb = {}, Ab = 0, hb, I, ua, Ca, Bb, H, ma = function () {
        }, $ = [], eb = 0, Ta = "div", X = "none", Zb = /^[0-9]+$/, $b = "stroke-width", ib, La, ub, vb, wb, Ua, jb, kb, Nb, Ob, xb, Pb, Qb, C = {}, P = W.Highcharts = W.Highcharts ? pa(16, !0) : {};
    ua = function (a, b, c) {
        if (!t(b) || isNaN(b))return "Invalid date";
        var a = o(a, "%Y-%m-%d %H:%M:%S"), d = new Date(b - La), e, f = d[vb](), g = d[wb](), h = d[Ua](), i = d[jb](), k = d[kb](), j = I.lang, l = j.weekdays, d = v({
            a: l[g].substr(0, 3),
            A: l[g],
            d: Qa(h),
            e: h,
    ...
    (function (a) {
        W.HighchartsAdapter = W.HighchartsAdapter ||
            a && {
                init: function (b) {
                    ...
                    a.fn.highcharts = function () {
                        ...
                        if (this[0]) {
                            ...
                            c === r && (d = $[V(this[0], "data-highcharts-chart")])
                        }
                        return d
                    }
    ...
    var M = W.HighchartsAdapter, Q = M || {};
    M && M.init.call(M, Bb);
    var nb = Q.adapterRun, ac = Q.getScript, wa = Q.inArray, q = Q.each, Cb = Q.grep, bc = Q.offset, xa = Q.map, A = Q.addEvent, R = Q.removeEvent, K = Q.fireEvent, cc = Q.washMouseEvent, ob = Q.animate, fb = Q.stop, Q = {
    ...
    var dc = /rgba\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]?(?:\.[0-9]+)?)\s*\)/, ec = /#([a-fA-F0-9]{2})([a-fA-F0-9]{2})([a-fA-F0-9]{2})/, fc = /rgb\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*\)/, Fa = function (a) {
        ...
        (function (a) {
            a && a.stops ? d = xa(a.stops, function (a) {
                return Fa(a[1])
            }) : (c = dc.exec(a)) ? b = [J(c[1]), J(c[2]), J(c[3]), parseFloat(c[4],
                10)] : (c = ec.exec(a)) ? b = [J(c[1], 16), J(c[2], 16), J(c[3], 16), 1] : (c = fc.exec(a)) && (b = [J(c[1]), J(c[2]), J(c[3]), 1])
        })(a);
        return {
            get: function (c) {
                var f;
                ...
                if (d)q(d, function (b) {
                    ...
                    var c;
                    for (c = 0; c < 3; c++)b[c] += J(a * 255), b[c] < 0 && (b[c] = 0), b[c] > 255 && (b[c] = 255)
                }
                return this
            },
    ...
    Z.prototype = {
        init: function (a, b) {
            this.element = b === "span" ? Y(b) : B.createElementNS(Ea, b);
            this.renderer = a
            ...
            if (e) {
                e = this.textWidth = a && a.width && d.nodeName.toLowerCase() === "text" && J(a.width);
                b && (a = v(b, c));
                this.styles = a;
                e && (ia || !ba && this.renderer.forExport) && delete a.width;
                if (Ha && !ba)E(this.element, a); else {
                    b = function (a, b) {
        ...
        invert: function () {
            ...
            f = e.alignedObjects;
            if (a) {
                if (this.alignOptions = a, this.alignByTranslate = b, !c || Oa(c))this.alignTo = d = c || "renderer", oa(f, this), f.push(this), c = null
            ...
            if (!a) {
                ...
                if (b.isSVG) {
                    ...
                    if (e)a.width = N(d * ha(g)) + N(c * ca(g)), a.height = N(d * ca(g)) + N(c * ha(g))
                }
                this.bBox = a;
                h && (b.cache[h] = a)
            }
        ...
        hide: function () {
            ...
            if (f)c.handleZ = !0, f = J(f);
            if (c.handleZ) {
                a = d.childNodes;
                for (g = 0; g < a.length; g++)if (b = a[g], c = V(b, "zIndex"), b !== e && (J(c) > f || !t(f) && t(c))) {
                    d.insertBefore(e,
                        b);
                    h = !0;
                    break
            ...
            if (a) {
                ...
                for (e = 1; e <= i; e++) {
                    ...
                    V(f, {
                        ...
                        transform: "translate" + j, fill: X
                    });
                    if (c)V(f, "height", w(V(f, "height") - h, 0)), f.cutHeight = h;
            ...
            if (a = a && a.toLowerCase()) {
                ...
                for (b = a.length; b--;)a[b] = J(a[b]) * this.element.getAttribute("stroke-width");
                a = a.join(",");
    ...
    ja.prototype =
    {
        ...
        g = d.element;
        a.appendChild(g);
        a.innerHTML.indexOf("xmlns") === -1 && V(g, "xmlns", Ea);
        this.isSVG = !0;
        this.box = g;
        this.boxWrapper = d;
        this.alignedObjects = [];
        this.url = ($a || mb) && B.getElementsByTagName("base").length ? f.href.replace(/#.*?$/, "").replace(/([\('\)])/g, "\\$1").replace(/ /g, "%20") : "";
        this.createElement("desc").add().element.appendChild(B.createTextNode("Created with Highstock 2.0.0"));
        ...
        destroy: function () {
            ...
            this.subPixelFix && R(W, "resize", this.subPixelFix);
        ...
        for (var b = a.element, c = this, d = c.forExport, e = o(a.textStr, "").toString(), f = e.indexOf("<") !== -1, g = b.childNodes, h, i, k = V(b, "x"), j = a.styles, l = a.textWidth,
                 m = j && j.lineHeight, n = g.length, p = function (a) {
                return m ? J(m) : c.fontMetrics(/(px|em)$/.test(a && a.style.fontSize) ? a.style.fontSize : j && j.fontSize || c.style.fontSize || 12).h
            }; n--;)b.removeChild(g[n]);
        !f && e.indexOf(" ") === -1 ? b.appendChild(B.createTextNode(e)) : (h = /<.*style="([^"]+)".*>/, i = /<.*href="(http[^"]+)".*>/, l && !a.added && this.box.appendChild(b), e = f ? e.replace(/<(b|strong)>/g, '<span style="font-weight:bold">').replace(/<(i|em)>/g, '<span style="font-style:italic">').replace(/<a/g, "<span").replace(/<\/(b|strong|i|em|a)>/g,
            ...
            q(g, function (e) {
                if (e !== "" || g.length === 1) {
                    ...
                    h.test(e) && (o = e.match(h)[1].replace(/(;| |^)color([ :])/, "$1fill$2"), V(u, "style", o));
                    i.test(e) && !d && (V(u, "onclick", 'location.href="' + e.match(i)[1] + '"'), E(u, {cursor: "pointer"}));
                    ...
                    if (e !== " ") {
                        ...
                        V(u, n);
                        !m && f && (!ba && d && E(u, {display: "block"}), V(u, "dy", p(u), mb && u.offsetHeight));
                        b.appendChild(u);
                        m++;
                        if (l)for (var e = e.replace(/([^\^])-/g, "$1- ").split(" "), n = e.length > 1 && j.whiteSpace !== "nowrap", q, r, D = a._clipHeight, t = [], s = p(), w = 1; n && (e.length || t.length);)delete a.bBox, q = a.getBBox(), r = q.width, !ba && c.forExport && (r = c.measureSpanWidth(u.firstChild.data, a.styles)), q = r > l, !q || e.length === 1 ? (e = t, t = [], e.length && (w++,
                            D && w * s > D ? (e = ["..."], a.attr("title", a.textStr)) : (u = B.createElementNS(Ea, "tspan"), V(u, {
                                dy: s,
                                x: k
                            }), o && V(u, "style", o), b.appendChild(u), r > l && (l = r)))) : (u.removeChild(u.firstChild), t.unshift(e.pop())), e.length && u.appendChild(B.createTextNode(e.join(" ").replace(/- /g, "-")))
                    }
                }
            })
        }))
        ...
        var k = this.label(a, b, c, i, null, null, null, null, "button"), j = 0, l, m, n, p, u, o, a = {
            ...
            "stroke-width": 1, stroke: "#CCCCCC", fill: {linearGradient: a, stops: [[0, "#FEFEFE"], [1, "#F6F6F6"]]},
        ...
        var e = ea(a) ? a.r : e, g = this.createElement("rect"), a = ea(a) ? a : a === r ? {} : {
            x: a,
            y: b,
            width: w(c, 0),
            height: w(d, 0)
        ...
        if (h)g = this.path(h), v(g, {
            ...
            x: b,
            y: c
        }), g.isImg = !0, a ? j(g, a) : (g.attr({width: 0, height: 0}), Y("img", {
            onload: function () {
        ...
        circle: function (a, b, c, d) {
            ...
            var f = e.start, c = e.r || c || d, g = e.end - 0.001,
                d = e.innerR, h = e.open, i = ca(f), k = ha(f), j = ca(g), g = ha(g), e = e.end - f < qa ? 0 : 1;
        ...
        var a = a || this.style.fontSize, a = /px/.test(a) ? J(a) : /em/.test(a) ? parseFloat(a) * 12 : 12, a = a < 24 ? a + 4 : s(a * 1.2), b = s(a * 0.8);
        return {h: a, b: b}
        ...
        function k() {
            ...
            ra = x + m.fontMetrics(a && a.fontSize).b;
            if (z) {
                if (!u)a = s(-G * x), b = h ? -ra : 0, n.box = u = d ? m.symbol(d, a, b, n.width, n.height, D) : m.rect(a, b, n.width, n.height, 0, D[$b]), u.attr("fill", X).add(n);
        ...
        function j() {
            ...
            c = h ? 0 : ra;
            if (t(bb) &&
                o && (a === "center" || a === "right"))b += {center: 0.5, right: 1}[a] * (bb - o.width);
        ...
        var m = this, n = m.g(i), p = m.text("", 0, 0, g).attr({zIndex: 1}), u, o, G = 0, x = 3, w = 0, bb, Eb, Fb, Gb, Ub = 0, D = {}, ra, z;
        n.onAdd = function () {
            p.add(n);
    ...
    v(Z.prototype, {
        htmlCss: function (a) {
            ...
            if (this.added) {
                ...
                if (b.tagName === "SPAN") {
                    var k = this.rotation, j, l = J(this.textWidth), m = [k, g, b.innerHTML, this.textWidth].join(",");
                    if (m !== this.cTT) {
                ...
                if (this.parentGroup = a) {
                    if (b = a.div, !b) {
                        ...
                        q(k.reverse(), function (a) {
                            var d;
                            b = a.div = a.div || Y(Ta, {className: V(a.element, "class")}, {
                                    position: "absolute",
    ...
    if (!ba && !ia)P.VMLElement = da = {
        init: function (a, b) {
            ...
            var a = this.rotation, b = ca(a * Ma), c = ha(a * Ma);
            E(this.element, {filter: a ? ["progid:DXImageTransform.Microsoft.Matrix(M11=", b, ", M12=", -c, ", M21=", c, ", M22=", b, ", sizingMethod='auto expand')"].join("") : X})
        },
        getSpanCorrection: function (a, b, c, d, e) {
            var f = d ? ca(d * Ma) : 1, g = d ? ha(d * Ma) : 0, h = o(this.elemHeight, this.element.offsetHeight), i;
            this.xCorr = f < 0 && -a;
            this.yCorr = g < 0 && -h;
            i = f * g < 0;
            ...
            for (var b = a.length, c = []; b--;)if (ka(a[b]))c[b] = s(a[b] * 10) - 5; else if (a[b] === "Z")c[b] = "x"; else if (c[b] = a[b], a.isArc && (a[b] === "wa" || a[b] === "at"))c[b + 5] ===
            ...
            var c, a = a.split(/[ ,]/);
            c = a.length;
            if (c === 9 || c === 11)a[c - 4] = a[c - 2] = J(a[c - 2]) - 10 * b;
            return a.join(" ")
        }, shadow: function (a, b, c) {
            ...
            if (a) {
                ...
                for (e = 1; e <= 3; e++) {
                    ...
                    h = Y(g.prepVML(k), null, {left: J(i.left) + o(a.offsetX, 1), top: J(i.top) + o(a.offsetY, 1)});
                    if (c)h.cutOff = l + 1;
            ...
            var d = c.nodeName;
            if (d === "SPAN")c.style.color = a; else if (d !== "IMG")c.filled = a !== X, this.setAttr("fillcolor", this.renderer.color(a, c, b, this))
        }, opacitySetter: ma, rotationSetter: function (a,
                                                        b, c) {
            c = c.style;
            this[b] = c[b] = a;
            c.left = -s(ha(a * Ma) + 1) + "px";
            c.top = s(ca(a * Ma)) + "px"
    ...
    }, da = fa(Z, da), da.prototype.ySetter = da.prototype.widthSetter = da.prototype.heightSetter = da.prototype.xSetter, da = {
        Element: da, isIE8: Da.indexOf("MSIE 8.0") > -1, init: function (a, b, c, d) {
            var e;
            this.alignedObjects = [];
        ...
        clipRect: function (a, b, c, d) {
            ...
            if (i) {
                ...
                if (c === "fill")if (i === "gradient")c = m.x1 || m[0] || 0, a = m.y1 || m[1] || 0, n = m.x2 || m[2] || 0, m = m.y2 || m[3] || 0, x = 'angle="' + (90 - U.atan((m - a) / (n - c)) * 180 / qa) + '"', s(); else {
                    var k = m.r, w = k * 2, v = k * 2, y = m.cx, D = m.cy, ra = b.radialReference, z, k = function () {
                        ra && (z = d.getBBox(), y += (ra[0] - z.x) / z.width - 0.5, D += (ra[1] - z.y) / z.height - 0.5, w *= ra[2] / z.width, v *= ra[2] / z.height);
                        x = 'src="' + I.global.VMLRadialGradientURL + '" size="' + w + "," + v + '" origin="0.5,0.5" position="' +
                            y + "," + D + '" color2="' + G + '" ';
                        s()
                    };
                    d.added ? k() : d.onAdd = k;
            ...
            } else if (g.test(a) && b.tagName !== "IMG")f = Fa(a), h = ["<", c, ' opacity="', f.get("a"), '"/>'], Y(this.prepVML(h), null, null, b), k = f.get("rgb"); else {
            ...
            E(a, {
                flip: "x",
                left: J(d.width) - (e ? J(e.top) : 1),
                top: J(d.height) - (e ? J(e.left) : 1),
                rotation: -90
            });
            ...
            arc: function (a, b, c, d, e) {
                var f = e.start, g = e.end, h = e.r || c ||
                    d, c = e.innerR, d = ca(f), i = ha(f), k = ca(g), j = ha(g);
                if (g - f === 0)return ["x"];
                ...
                return ja.prototype.symbols[!t(e) || !e.r ? "square" : "callout"].call(0, a, b, c, d, e)
            }
        }
    }, P.VMLRenderer = gb = function () {
        this.init.apply(this,
            arguments)
    }, gb.prototype = y(ja.prototype, da), Wa = gb;
    ...
    var Vb;
    if (ia)P.CanVGRenderer = da = function () {
        Ea = "http://www.w3.org/1999/xhtml"
    }, da.prototype.symbols = {}, Vb = function () {
        function a() {
            var a = b.length, d;
            for (d = 0; d < a; d++)b[d]();
            b = []
    ...
    Za.prototype = {
        addLabel: function () {
            ...
            b = a.labelFormatter.call({
                axis: a, chart: c, isFirst: k, isLast: j, dateTimeLabelFormat: l, value: a.isLog ? ga(na(f)) :
                    f
            });
            ...
            if (t(e))e && e.attr({text: b}).css(g); else {
                ...
                if (ka(h.rotation))l.rotation = h.rotation;
    ...
    F.prototype = {
        ...
        init: function (a, b) {
            ...
            this.crosshair = o(d.crosshair, la(a.options.tooltip.crosshairs)[c ? 0 : 1], !1);
            ...
            if (this.isLog)this.val2lin = Ga, this.lin2val = na
        },
        setOptions: function (a) {
            this.options = y(this.defaultOptions, this.isXAxis ? {} : this.defaultYAxisOptions, [this.defaultTopAxisOptions, this.defaultRightAxisOptions, this.defaultBottomAxisOptions, this.defaultLeftAxisOptions][this.side], y(I[this.coll], a))
        },
        defaultLabelFormatter: function () {
            var a = this.axis, b = this.value, c = a.categories, d = this.dateTimeLabelFormat, e = I.lang.numericSymbols, f = e && e.length, g, h = a.options.labels.format,
        ...
        translate: function (a, b, c, d, e, f) {
            ...
            b ? (a = a * g + h, a -= k, a = a / i + d, e && (a = this.lin2val(a))) : (e && (a = this.val2lin(a)), f === "between" && (f = 0.5), a = g * (a - d) * i + h + g * k + (ka(f) ? i * f * this.pointRange : 0));
            return a
        },
        ...
        getLinearTickPositions: function (a, b, c) {
            var d, e = ga(S(b / a) * a), f = ga(Va(c / a) * a), g = [];
        ...
        setTickPositions: function (a) {
            ...
            h ? (b.linkedParent = c[b.coll][d.linkedTo],
                c = b.linkedParent.getExtremes(), b.min = o(c.min, c.dataMin), b.max = o(c.max, c.dataMax), d.type !== b.linkedParent.options.type && pa(11, 1)) : (b.min = o(b.userMin, d.min, b.dataMin), b.max = o(b.userMax, d.max, b.dataMax));
            if (e)!a && z(b.min, o(b.dataMin, b.min)) <= 0 && pa(10, 1), b.min = ga(Ga(b.min)), b.max = ga(Ga(b.max));
            ...
            if (ka(d.floor))b.min = w(b.min, d.floor);
            if (ka(d.ceiling))b.max = z(b.max, d.ceiling);
            ...
            if (!h)e = a[0], f = a[a.length - 1], h = b.minPointOffset || 0, d.startOnTick ? b.min = e : b.min - h > e && a.shift(), d.endOnTick ? b.max = f : b.max + h < f && a.pop(), a.length === 1 && (d = N(b.max) > 1E13 ? 1 : 0.001, b.min -= d, b.max += d)
        },
        ...
        getOffset: function () {
            var a = this, b = a.chart, c = b.renderer, d = a.options,
                e = a.tickPositions, f = a.ticks, g = a.horiz, h = a.side, i = b.inverted ? [1, 0, 3, 2][h] : h, k, j = 0, l, m = 0, n = d.title, p = d.labels, u = 0, Db = b.axisOffset, G = b.clipOffset, x = [-1, 1, 1, -1][h], s, v = 1, y = o(p.maxStaggerLines, 5), z, A, B, D, ra = h === 2 ? c.fontMetrics(p.style.fontSize).b : 0;
            ...
            a.axisTitleMargin = o(l, u + m + (u && x * d.labels[g ? "y" : "x"] - ra));
        ...
        getTitlePosition: function () {
            var a = this.horiz, b = this.left, c = this.top, d = this.len, e = this.options.title, f = a ? b : c, g = this.opposite, h = this.offset, i = J(e.style.fontSize || 12), d = {
                low: f + (a ? 0 : d),
                middle: f + d / 2,
                high: f + (a ? d : 0)
    ...
    F.prototype.getTimeTicks = function (a, b, c, d) {
        var e = [], f = {}, g = I.global.useUTC, h, i = new Date(b - La), k = a.unitRange, j = a.count;
        if (t(b)) {
    ...
    F.prototype.getLogTickPositions = function (a, b, c, d) {
        ...
        if (a >= 0.5)a = s(a), g = this.getLinearTickPositions(a, b, c); else if (a >= 0.08)for (var f = S(b), h, i, k, j, l, e = a > 0.3 ? [1, 2, 4] : a > 0.15 ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; f < c + 1 && !l; f++) {
            i = e.length;
            for (h = 0; h < i && !l; h++)k = Ga(na(f) * e[h]), k > b && (!d ||
            j <= c) && g.push(j), j > c && (l = !0), j = k
        } else if (b = na(b), c = na(c), a = e[d ? "minorTickInterval" : "tickInterval"], a = o(a === "auto" ? null : a, this._minorAutoInterval, (c - b) * (e.tickPixelInterval / (d ? 5 : 1)) / ((d ? f / this.tickPositions.length : f) || 1)), a = sb(a, null, rb(a)), g = xa(this.getLinearTickPositions(a, b, c), Ga), !d)this._minorAutoInterval = a / 5;
    ...
    Hb.prototype = {
        init: function (a, b) {
            ...
            var c, d = this.chart, e = d.inverted, f = d.plotTop, g = 0, h = 0, i, a = la(a);
            c = a[0].tooltipPos;
            ...
            var b = this.points || la(this), c = b[0].series, d;
            ...
            i === !1 ? this.hide() : (this.isHidden && (fb(d), d.attr("opacity", 1).show()), d.attr({text: i}), j = e.borderColor || a.color || h.color || "#606060", d.attr({stroke: j}), this.updatePosition({
                plotX: f,
                plotY: g,
                negative: a.negative,
                ttBelow: a.ttBelow
            }), this.isHidden = !1);
            K(c, "tooltipRefresh", {text: i, x: f + c.plotLeft, y: g + c.plotTop, borderColor: j})
            ...
            var b = a.series, c = b.tooltipOptions, d = c.dateTimeLabelFormats, e = c.xDateFormat, f = b.xAxis, g = f && f.options.type === "datetime" && ka(a.key), c = c.headerFormat, f = f && f.closestPointRange, h;
            if (g && !e) {
                if (f)for (h in H) {
    ...
    Xa.prototype = {
        init: function (a, b) {
            ...
            if (d && this.options.tooltip.shared && (!h || !h.noSharedTooltip)) {
                f = [];
                i = c.length;
                for (k = 0; k < i; k++)if (c[k].visible && c[k].options.enableMouseTracking !== !1 && !c[k].noSharedTooltip && c[k].singularTooltips !== !0 && c[k].tooltipPoints.length && (e = c[k].tooltipPoints[l]) && e.series)e._dist = N(l - e.clientX),
            ...
            }), K(c.series, "click", v(a, {point: c})), b.hoverPoint && c.firePointEvent("click", a)) : (v(a, this.getCoordinates(a)), b.isInsidePlot(a.chartX - d, a.chartY - e) && K(b, "click",
                a))
            ...
            eb === 1 && A(B, "mouseup", a.onDocumentMouseUp);
            if (ab)b.ontouchstart = function (b) {
                a.onContainerTouchStart(b)
            }, b.ontouchmove = function (b) {
                a.onContainerTouchMove(b)
            }, eb === 1 && A(B, "touchend", a.onDocumentTouchEnd)
        }, destroy: function () {
            var a;
            R(this.chart.container,
                "mouseleave", this.onContainerMouseLeave);
            eb || (R(B, "mouseup", this.onDocumentMouseUp), R(B, "touchend", this.onDocumentTouchEnd));
    ...
    v(P.Pointer.prototype, {
        pinchTranslate: function (a, b, c, d, e, f) {
            ...
            var i = this.chart, k = a ? "x" : "y", j = a ? "X" : "Y", l = "chart" +
                j, m = a ? "width" : "height", n = i["plot" + (a ? "Left" : "Top")], p, u, o = h || 1, q = i.inverted, x = i.bounds[a ? "h" : "v"], r = b.length === 1, s = b[0][l], t = c[0][l], w = !r && b[1][l], v = !r && c[1][l], y, c = function () {
                !r && N(s - w) > 20 && (o = h || N(t - v) / N(s - w));
                u = (n - t) / o + s;
            ...
            var b =
                this, c = b.chart, d = b.pinchDown, e = b.followTouchMove, f = a.touches, g = f.length, h = b.lastValidTouch, i = b.hasZoom, k = b.selectionMarker, j = {}, l = g === 1 && (b.inClass(a.target, "highcharts-tracker") && c.runTrackerClick || c.runChartClick), m = {};
            ...
            if (a.type === "touchstart")q(f, function (a, b) {
                ...
                if (a.zoomEnabled) {
                    var b = c.bounds[a.horiz ?
                        "h" : "v"], d = a.minPixelPadding, e = a.toPixels(a.dataMin), f = a.toPixels(a.dataMax), g = z(e, f), e = w(e, f);
                    b.min = z(a.pos, g - d);
                    b.max = w(a.pos + a.len, e + d)
                }
            }); else if (d.length) {
                if (!k)b.selectionMarker = k = v({destroy: ma}, c.plotBox);
    ...
    if (W.PointerEvent || W.MSPointerEvent) {
        var ya = {}, Ib = !!W.PointerEvent, gc = function () {
            var a, b = [];
            b.item = function (a) {
                return this[a]
            };
    ...
    pb.prototype = {
        init: function (a, b) {
            ...
            this.options = b;
            if (b.enabled)c.baseline = J(d.fontSize) + 3 + f, c.itemStyle = d, c.itemHiddenStyle = y(d, b.itemHiddenStyle), c.itemMarginTop = f, c.padding = e, c.initialItemX =
                e, c.initialItemY = e - 5, c.maxItemWidth = 0, c.chart = a, c.itemHeight = 0, c.lastLineHeight = 0, c.symbolWidth = o(b.symbolWidth, 16), c.pages = [], c.render(), A(c.chart, "endResize", function () {
            ...
            if (f) {
                if (g && f.isMarker)for (k in i.stroke =
                    h, g = a.convertAttribs(g), g)d = g[k], d !== r && (i[k] = d);
                f.attr(i)
            }
            ...
            var b = this.chart, c = b.renderer, d = this.options, e = d.layout === "horizontal", f = this.symbolWidth, g = d.symbolPadding, h = this.itemStyle, i = this.itemHiddenStyle, k = this.padding, j = e ? o(d.itemDistance, 20) : 0, l = !d.rtl, m = d.width, n = d.itemMarginBottom || 0, p = this.itemMarginTop, u = this.initialItemX, q = a.legendItem, G = a.series && a.series.drawLegendSymbol ? a.series : a, x = G.options, x = this.createCheckboxForItem &&
                x && x.showCheckbox, r = d.useHTML;
            if (!q)a.legendGroup = c.g("legend-item").attr({zIndex: 1}).add(this.scrollGroup), G.drawLegendSymbol(this, a), a.legendItem = q = c.text(d.labelFormat ? Ja(d.labelFormat, a) : d.labelFormatter.call(a), l ? f + g : -g, this.baseline, r).css(y(a.visible ? h : i)).attr({
                align: l ? "left" : "right",
                zIndex: 2
            ...
            if (e && this.itemX - u + f > (m || b.chartWidth - 2 * k - u - d.x))this.itemX = u, this.itemY += p + this.lastLineHeight + n, this.lastLineHeight = 0;
            ...
            var b = this, c = this.chart, d = c.renderer, e = this.options, f = e.y, f = c.spacingBox.height + (e.verticalAlign === "top" ? -f : f) - this.padding, g = e.maxHeight, h, i = this.clipRect, k = e.navigation, j = o(k.animation, !0), l = k.arrowSize || 12, m = this.nav, n = this.pages,
                p, u = this.allItems;
    ...
    va.prototype = {
        init: function (a, b) {
            ...
            (b = C[a.type || b.type || b.defaultSeriesType]) || pa(17, !0);
            b = new b;
            b.init(this,
                a);
            return b
            ...
            var a = this, b = this.options, c = b.xAxis = la(b.xAxis || {}), b = b.yAxis = la(b.yAxis || {});
            q(c, function (a, b) {
                a.index = b;
                a.isX = !0
            });
            ...
            a || pa(13, !0);
            c = J(V(a, "data-highcharts-chart"));
            !isNaN(c) && $[c] && $[c].hasRendered && $[c].destroy();
            ...
            this.renderer = b.forExport ? new ja(a, c, d, b.style, !0) : new Wa(a, c, d, b.style);
            ...
            if (c.display && !e.floating)if (i === "right") {
                if (!t(d[1]))this.marginRight =
                    w(this.marginRight, c.legendWidth - g + f + a[1])
            } else if (i === "left") {
            ...
            var b = this, c = b.options.chart, d = b.renderTo, e = c.width || nb(d, "width"), f = c.height || nb(d, "height"), c = a ? a.target : W, d = function () {
                if (b.container)b.setSize(e, f, !1), b.hasUserSize = null
            };
            if (!b.hasUserSize && e && f && (c === W || c === B)) {
            ...
            var a = this.options.chart, b = this.renderer, c = this.chartWidth, d = this.chartHeight, e = this.chartBackground, f = this.plotBackground, g = this.plotBorder, h = this.plotBGImage, i = a.borderWidth || 0, k = a.backgroundColor, j = a.plotBackgroundColor, l = a.plotBackgroundImage,
                m = a.plotBorderWidth || 0, n, p = this.plotLeft, u = this.plotTop, o = this.plotWidth, q = this.plotHeight, x = this.plotBox, r = this.clipRect, s = this.clipBox;
            n = i + (a.shadow ? 8 : 0);
            ...
            e.items && q(e.items, function (b) {
                var d = v(e.style, b.style), f = J(d.left) + a.plotLeft, g = J(d.top) + a.plotTop + 12;
                delete d.left;
                delete d.top;
            ...
            var a = this;
            return !ba && W == W.top && B.readyState !== "complete" || ia && !W.canvg ? (ia ? Vb.push(function () {
                a.firstRender()
    ...
    za.prototype = {
        init: function (a, b, c) {
            ...
            if (d)this.y = this[d];
            if (this.x ===
                r && c)this.x = b === r ? c.autoIncrement() : b;
            return this
    ...
    L.prototype = {
        ...
        init: function (a, b) {
            var c = this, d, e, f = a.series, g = function (a, b) {
                return o(a.options.index, a._i) - o(b.options.index,
                        b._i)
            };
            c.chart = a;
        ...
        setOptions: function (a) {
            ...
            this.userOptions = a;
            c = y(e, c.series, a);
            this.tooltipOptions = y(I.tooltip, I.plotOptions[this.type].tooltip, b.tooltip, d.series && d.series.tooltip, d[this.type] && d[this.type].tooltip, a.tooltip);
        ...
        setData: function (a, b, c, d) {
            var e = this, f = e.points, g = f && f.length || 0, h, i = e.options, k = e.chart, j = null, l = e.xAxis, m = l && !!l.categories, n = e.tooltipPoints, p = i.turboThreshold, u = this.xData, s = this.yData, G = (h = e.pointArrayMap) && h.length, a = a || [];
            h = a.length;
            b = o(b, !0);
            if (d !== !1 && h && g === h && !e.cropped && !e.hasGroupedData)q(a, function (a, b) {
                ...
                if (p && h > p) {
                    ...
                    if (ka(j)) {
                        ...
                        e.xIncrement = m
                    } else if (Pa(j))if (G)for (c = 0; c < h; c++)i = a[c], u[c] = i[0], s[c] = i.slice(1, G + 1); else for (c = 0; c < h; c++)i = a[c], u[c] = i[0], s[c] = i[1]; else pa(12)
        ...
        processData: function (a) {
            ...
            e = 0;
            var f, g, h = this.xAxis, i = this.options, k = i.cropThreshold, j = 0, l = this.isCartesian, m, n;
            if (l && !this.isDirty && !h.isDirty && !this.yAxis.isDirty && !a)return !1;
            if (l && this.sorted && (!k || d > k || this.forceCrop))if (m = h.min, n = h.max, b[d - 1] < m || b[0] > n)b = [], c = []; else if (b[0] < m || b[d - 1] > n)e = this.cropData(this.xData, this.yData, m, n), b = e.xData, c = e.yData,
                e = e.start, f = !0, j = b.length;
            for (d = b.length - 1; d >= 0; d--)a = b[d] - b[d - 1], !f && b[d] > m && b[d] < n && j++, a > 0 && (g === r || a < g) ? g = a : a < 0 && this.requireSorting && pa(15);
            this.cropped = f;
            this.cropStart = e;
        ...
        generatePoints: function () {
            ...
            for (m = 0; m < g; m++)i = h + m, k ? l[m] = (new f).init(this, [d[m]].concat(la(e[m]))) : (b[i] ? j = b[i] : a[i] !== r && (b[i] = j = (new f).init(this, a[i], d[m])), l[m] = j);
            if (b && (g !== (c = b.length) || k))for (m = 0; m < c; m++)if (m === h && !k && (m += g), b[m])b[m].destroyElements(), b[m].plotX =
                r;
            this.data = b;
            this.points = l
        },
        ...
        translate: function () {
            ...
            this.processData();
            this.generatePoints();
            for (var a = this.options, b = a.stacking, c = this.xAxis, d = c.categories, e = this.yAxis, f = this.points, g = f.length, h = !!this.modifyValue, i = a.pointPlacement, k = i === "between" || ka(i), j = a.threshold, a = 0; a < g; a++) {
                ...
                if (b && this.visible && u && u[m])u = u[m], n = u.points[this.index + "," + a], p = n[0], n = n[1], p === 0 && (p = o(j, e.min)),
                e.isLog && p <= 0 && (p = null), l.total = l.stackTotal = u.total, l.percentage = u.total && l.y / u.total * 100, l.stackY = n, u.setOffset(this.pointXOffset || 0, this.barW || 0);
        ...
        animate: function (a) {
            ...
            if (d && !ea(d))d = T[this.type].animation;
            g = ["_sharedClip", d.duration, d.easing, e.height].join(",");
            a ? (a = b[g], d = b[g + "m"], a || (b[g] = a = c.clipRect(v(e, {width: 0})), b[g + "m"] = d = c.clipRect(-99, f ? -b.plotLeft : -b.plotTop, 99, f ? b.chartWidth : b.chartHeight)), this.group.clip(a), this.markerGroup.clip(d), this.sharedClipKey = g) : ((a = b[g]) && a.animate({width: b.plotSizeX}, d), b[g + "m"] && b[g + "m"].animate({width: b.plotSizeX + 99}, d), this.animate = null)
        },
        ...
        drawPoints: function () {
            ...
            if (d.enabled !== !1 || this._hasPointMarkers)for (f =
                                                                   b.length; f--;)if (g = b[f], d = S(g.plotX), e = g.plotY, j = g.graphic, i = g.marker || {}, a = p && i.enabled === r || i.enabled, m = c.isInsidePlot(s(d), e, c.inverted), a && e !== r && !isNaN(e) && g.y !== null)if (a = g.pointAttr[g.selected ? "select" : ""] || l, h = a.r, i = o(i.symbol, this.symbol), k = i.indexOf("url") === 0, j)j[m ? "show" : "hide"](!0).animate(v({
                x: d - h,
                y: e - h
        ...
        getAttribs: function () {
            var a = this, b = a.options, c = T[a.type].marker ? b.marker : b, d = c.states, e = d.hover, f, g = a.color;
            f = {stroke: g, fill: g};
            ...
            b.marker ? (e.radius = e.radius || c.radius + 2, e.lineWidth = e.lineWidth || c.lineWidth + 1) : e.color =
                e.color || Fa(e.color || g).brighten(e.brightness).get();
            ...
            if (!i || g < i || j)for (; g--;) {
                ...
                if (j) {
                    ...
                    if (!b.marker)f.color = f.color || !i.options.color && e.color ||
                        Fa(i.color).brighten(f.brightness || e.brightness).get();
                    f = {color: i.color};
        ...
        drawGraph: function () {
            ...
            q(c, function (c, h) {
                var j = c[0], l = a[j];
                if (l)fb(l), l.animate({d: g}); else if (d && g.length)l = {
                    stroke: c[1],
                    "stroke-width": d,
                    fill: X,
                    zIndex: 1
                }, e ? l.dashstyle = e : f && (l["stroke-linecap"] = l["stroke-linejoin"] = "round"), a[j] = a.chart.renderer.path(g).attr(l).add(a.group).shadow(!h && b.shadow)
            })
        },
        clipNeg: function () {
            ...
            e = b.chartWidth;
            var k =
                b.chartHeight, j = w(e, k), l = this.yAxis;
            if (d && (f || g)) {
        ...
        render: function () {
            var a = this, b = a.chart, c, d = a.options, e = (c = d.animation) && !!a.animate && b.renderer.isSVG && o(c.duration, 500) || 0, f = a.visible ? "visible" : "hidden", g = d.zIndex, h = a.hasRendered, i = b.seriesGroup;
    ...
    Rb.prototype = {
        destroy: function () {
            ...
            var c = this.axis, d = c.chart, e = d.inverted, f = this.isNegative, g = c.translate(c.usePercentage ? 100 : this.total, 0, 0, 0, 1), c = c.translate(0), c = N(g - c), h = d.xAxis[0].translate(this.x) + a, i = d.plotHeight, f = {
                x: e ? f ? g : g - c : h,
    ...
    F.prototype.buildStacks = function () {
        var a = this.series,
            b = o(this.options.reversedStacks, !0), c = a.length;
        if (!this.isXAxis) {
    ...
    L.prototype.setStackedPoints =
        function () {
            if (this.options.stacking && !(this.visible !== !0 && this.chart.options.chart.ignoreHiddenSeries !== !1)) {
                var a = this.processedXData, b = this.processedYData, c = [], d = b.length, e = this.options, f = e.threshold, g = e.stack, e = e.stacking, h = this.stackKey, i = "-" + h, k = this.negStacks, j = this.yAxis, l = j.stacks, m = j.oldStacks, n, p, u, o, q, x;
                for (o = 0; o < d; o++) {
                    q = a[o];
                    x = b[o];
                    u = this.index + "," + o;
                    p = (n = k && x < f) ? i : h;
                    l[p] || (l[p] = {});
                    if (!l[p][q])m[p] && m[p][q] ? (l[p][q] = m[p][q], l[p][q].total = null) : l[p][q] = new Rb(j, j.options.stackLabels,
                        n, q, g);
                    p = l[p][q];
                    p.points[u] = [p.cum || 0];
                    e === "percent" ? (n = n ? h : i, k && l[n] && l[n][q] ? (n = l[n][q], p.total = n.total = w(n.total, p.total) + N(x) || 0) : p.total = ga(p.total + (N(x) || 0))) : p.total = ga(p.total + (x || 0));
                    p.cum = (p.cum || 0) + (x || 0);
    ...
    L.prototype.setPercentStacks = function () {
        ...
        q([b, "-" + b], function (b) {
            var e;
            for (var f = d.length, g, h; f--;)if (g = d[f], e = (h = c[b] &&
                        c[b][g]) && h.points[a.index + "," + f], g = e)h = h.total ? 100 / h.total : 0, g[0] = ga(g[0] * h), g[1] = ga(g[1] * h), a.stackedYData[f] = g[1]
        })
    };
    v(va.prototype, {
        addSeries: function (a, b, c) {
            var d, e = this;
            a && (b = o(b, !0), K(e, "addSeries", {options: a}, function () {
                d = e.initSeries(a);
                e.isDirtyLegend = !0;
                e.linkSeries();
                b && e.redraw(c)
            ...
            new F(this, y(a, {index: this[e].length, isX: b}));
            f[e] = la(f[e] || {});
            f[e].push(a);
            o(c, !0) && this.redraw(d)
            ...
            if (!c)this.loadingDiv = c = Y(Ta, {className: "highcharts-loading"}, v(d.style, {
                zIndex: 10,
                display: X
    ...
    v(L.prototype, {
        addPoint: function (a, b, c, d) {
            var e = this.options, f = this.data, g = this.graph, h = this.area, i = this.chart, k = this.xAxis && this.xAxis.names, j = g && g.shift || 0, l = e.data, m, n = this.xData;
            Ya(d, i);
    ...
    var Aa = fa(L);
    C.line = Aa;
    T.area = y(M, {threshold: 0});
    var ta = fa(L, {
        type: "area", getSegments: function () {
            var a =
                [], b = [], c = [], d = this.xAxis, e = this.yAxis, f = e.stacks[this.stackKey], g = {}, h, i, k = this.points, j = this.options.connectNulls, l, m, n;
            if (this.options.stacking && !this.cropped) {
                ...
                b.length && a.push(b)
            } else L.prototype.getSegments.call(this), a = this.segments;
            this.segments = a
        }, getSegmentPath: function (a) {
    ...
    Aa = fa(L, {
        ...
        getColumnMetrics: function () {
            ...
            var c = z(N(c.transA) * (c.ordinalSlope || b.pointRange || c.closestPointRange || c.tickInterval || 1), c.len), k = c * b.groupPadding, j = (c - 2 * k) / i, l = b.pointWidth, b = t(l) ? (j - l) / 2 : j * b.pointPadding, l = o(l, j - 2 * b);
            return a.columnMetrics = {
                width: l, offset: b + (k + ((e ? i - (a.columnIndex ||
                0) : a.columnIndex) || 0) * j - c / 2) * (e ? -1 : 1)
            }
        },
        translate: function () {
            var a = this, b = a.chart, c = a.options, d = a.borderWidth = o(c.borderWidth, a.activePointCount > 0.5 * a.xAxis.len ? 0 : 1), e = a.yAxis, f = a.translatedThreshold = e.getThreshold(c.threshold), g = o(c.minPointLength, 5), c = a.getColumnMetrics(), h = c.width, i = a.barW = Va(w(h, 1 + 2 * d)), k = a.pointXOffset = c.offset, j = -(d % 2 ? 0.5 : 0), l = d % 2 ? 0.5 : 1;
            b.renderer.isVML && b.inverted && (l += 1);
            L.prototype.translate.apply(a);
            q(a.points, function (c) {
                var d = o(c.yBottom, f), p = z(w(-999 - d, c.plotY), e.len +
                    999 + d), u = c.plotX + k, q = i, r = z(p, d), x;
                x = w(p, d) - r;
                N(x) < g && g && (x = g, r = s(N(r - f) > g ? d - g : f - (e.translate(c.y, 0, 1, 0, 1) <= f ? g : 0)));
                c.barX = u;
                c.pointWidth = h;
        ...
        drawPoints: function () {
            ...
            q(a.points, function (i) {
                ...
                if (k !== r && !isNaN(k) && i.y !== null)f = i.shapeArgs, h = t(a.borderWidth) ? {"stroke-width": a.borderWidth} : {}, g = i.pointAttr[i.selected ? "select" : ""] || a.pointAttr[""], j ? (fb(j), j.attr(h)[b.pointCount < e ? "animate" : "attr"](y(f))) : i.graphic = d[i.shapeType](f).attr(g).attr(h).add(a.group).shadow(c.shadow, null, c.stacking && !c.borderRadius); else if (j)i.graphic = j.destroy()
            })
        },
        animate: function (a) {
            var b = this.yAxis, c = this.options, d = this.chart.inverted, e = {};
            if (ba)a ?
                (e.scaleY = 0.001, a = z(b.pos + b.len, w(b.pos, b.toPixels(c.threshold))), d ? e.translateX = a - b.len : e.translateY = a, this.group.attr(e)) : (e.scaleY = 1, e[d ? "translateX" : "translateY"] = b.pos, this.group.animate(e, this.options.animation), this.animate = null)
        },
        remove: function () {
            var a = this, b = a.chart;
            b.hasRendered && q(b.series, function (b) {
    ...
    T.pie = y(M, {
        ...
        clip: !1,
        colorByPoint: !0,
        dataLabels: {distance: 30, enabled: !0, format: "{point.name}"},
        ignoreHiddenPoint: !0,
        legendType: "point",
        marker: null,
        size: null,
    ...
    M = {
        ...
        translate: function (a) {
            this.generatePoints();
            var b = 0, c = this.options, d = c.slicedOffset, e = d + c.borderWidth, f, g, h, i = c.startAngle || 0, k = this.startAngleRad = qa / 180 * (i - 90), i = (this.endAngleRad = qa / 180 * (o(c.endAngle, i + 360) - 90)) - k, j = this.points, l = c.dataLabels.distance, c = c.ignoreHiddenPoint, m, n = j.length, p;
            if (!a)this.center = a = this.getCenter();
            this.getX = function (b, c) {
                h = U.asin(z((b - a[1]) / (a[2] / 2 + l), 1));
                return a[0] + (c ? -1 : 1) * ca(h) * (a[2] /
                    2 + l)
            };
            for (m = 0; m < n; m++) {
                p = j[m];
                ...
                p.slicedTranslation = {translateX: s(ca(h) * d), translateY: s(ha(h) * d)};
                f = ca(h) * a[2] / 2;
                g = ha(h) * a[2] / 2;
                p.tooltipPos = [a[0] + f * 0.7, a[1] + g * 0.7];
                p.half = h < -qa / 2 || h > qa / 2 ? 1 : 0;
                p.angle = h;
                e = z(e, l / 2);
                p.labelPos = [a[0] + f + ca(h) * l, a[1] + g + ha(h) * l, a[0] + f + ca(h) * e, a[1] + g + ha(h) * e, a[0] + f, a[1] + g,
        ...
        drawPoints: function () {
            ...
            q(a.points, function (h) {
                ...
                f && f.attr(c);
                d ? d.animate(v(g, c)) : h.graphic = d = b[h.shapeType](g).setRadialReference(a.center).attr(h.pointAttr[h.selected ? "select" :
    ...
    L.prototype.drawDataLabels = function () {
        ...
        if (d.enabled || a._hasPointLabels)a.dlProcessOptions && a.dlProcessOptions(d), i = a.plotGroup("dataLabelsGroup",
            "data-labels", "hidden", d.zIndex || 6), !a.hasRendered && o(d.defer, !0) && (i.attr({opacity: 0}), A(a, "afterAnimate", function () {
            ...
            if (l && !e)b.dataLabel = l.destroy(); else if (e) {
                ...
                d.style.color = o(d.color, d.style.color,
                    a.color, "black");
    ...
    L.prototype.alignDataLabel =
        function (a, b, c, d, e) {
            ...
            }, b[e ? "attr" : "animate"](g)) : (b.align(c, null, d), g = b.alignAttr, o(c.overflow, "justify") === "justify" ? this.justifyDataLabel(b,
                c, g, k, d, e) : o(c.crop, !0) && (a = f.isInsidePlot(g.x, g.y) && f.isInsidePlot(g.x + k.width, g.y + k.height)));
    ...
    L.prototype.justifyDataLabel = function (a, b, c, d, e, f) {
        ...
        k = c.y + d.height;
        if (k > g.plotHeight)i === "top" ? b.verticalAlign = "bottom" : b.y = g.plotHeight -
            k, j = !0;
        if (j)a.placed = !f, a.align(b, null, e)
    };
    if (C.pie)C.pie.prototype.drawDataLabels = function () {
        var a = this, b = a.data, c, d = a.chart, e = a.options.dataLabels, f = o(e.connectorPadding, 10), g = o(e.connectorWidth, 1), h = d.plotWidth, d = d.plotHeight, i, k, j = o(e.softConnector, !0), l = e.distance, m = a.center, n = m[2] / 2, p = m[1], u = l > 0, r, G, x, t, v = [[], []], y, z, A, B, D, C = [0, 0, 0, 0], J = function (a, b) {
            return b.y - a.y
        };
        if (a.visible && (e.enabled || a._hasPointLabels)) {
            ...
            for (B = 2; B--;) {
                var b = [], H = [], E = v[B], I = E.length, F;
                a.sortByAngle(E, B - 0.5);
                if (l > 0) {
                    ...
                    if (I > G) {
                        c = [].concat(E);
                        c.sort(J);
                        for (D = I; D--;)c[D].rank = D;
                        for (D = I; D--;)E[D].rank >= G && E.splice(D, 1);
                        I = E.length
                    }
                    for (D = 0; D < I; D++) {
                        c = E[D];
                        ...
                        c = 9999;
                        var M, K;
                        for (K = 0; K < G; K++)M = N(b[K] - x[1]), M < c && (c = M, F = K);
                        if (F < D && b[D] !== null)F = D; else for (G < I - D + F && b[D] !== null && (F = G - I + D); b[F] === null;)F++;
                        H.push({
                            i: F,
                            y: b[F]
                        });
                ...
                for (D = 0; D < I; D++) {
                    ...
                    r.connX = y;
                    r.connY = z;
                    if (this.options.size === null)G = r.width, y - G < f ? C[3] = w(s(G - y + f), C[3]) : y + G > h - f && (C[1] = w(s(y + G - h + f), C[1])), z - t / 2 < 0 ? C[0] =
                        w(s(-z + t / 2), C[0]) : z + t / 2 > d && (C[2] = w(s(z + t / 2 - d), C[2]))
                }
            }
            if (Ba(C) === 0 || this.verifyDataLabelOverflow(C))this.placeDataLabels(), u && g && q(this.points, function (b) {
                i = b.connector;
                x = b.labelPos;
    ...
    }, C.pie.prototype.alignDataLabel = ma, C.pie.prototype.verifyDataLabelOverflow = function (a) {
        var b = this.center, c = this.options, d = c.center, e = c = c.minSize || 80, f;
        d[0] !== null ? e = w(b[2] - w(a[1], a[3]), c) : (e = w(b[2] -
    ...
    var cb = P.TrackerMixin = {
        drawTrackerPoint: function () {
            ...
            var a = this, b = a.options, c = b.trackByArea, d = [].concat(c ?
                a.areaPath : a.graphPath), e = d.length, f = a.chart, g = f.pointer, h = f.renderer, i = f.options.tooltip.snap, k = a.tracker, j = b.cursor, l = j && {cursor: j}, j = a.singlePoints, m, n = function () {
    ...
    if (C.column)Aa.prototype.drawTracker = cb.drawTrackerPoint;
    if (C.pie)C.pie.prototype.drawTracker = cb.drawTrackerPoint;
    if (C.scatter)ta.prototype.drawTracker = cb.drawTrackerPoint;
    if (C.gauge)C.gauge.prototype.drawTracker =
        cb.drawTrackerPoint;
    v(pb.prototype, {
        setItemEvents: function (a, b, c, d, e) {
            ...
            a.checkbox = Y("input", {type: "checkbox", checked: a.selected, defaultChecked: a.selected},
    ...
    v(va.prototype, {
        showResetZoom: function () {
            var a = this, b = I.lang, c = a.options.chart.resetZoomButton, d = c.theme, e = d.states, f = c.relativeTo === "chart" ? null : "plotBox";
            ...
            b && this.redraw(o(this.options.chart.animation,
    ...
    v(za.prototype, {
        select: function (a, b) {
            ...
            var b =
                this.series, c = b.chart, d = c.tooltip, e = c.hoverPoint;
            ...
            if (!(a === this.state && !b || this.selected && a !== "select" || f[a] && f[a].enabled === !1 || a && (k || h && i.enabled === !1) || a && l.states && l.states[a] && l.states[a].enabled === !1)) {
                ...
                if ((c = f[a] && f[a].halo) && c.size) {
                    ...
                    n.attr(v({fill: Fa(this.color || e.color).setOpacity(c.opacity).get()},
    ...
    v(L.prototype, {
        onMouseOver: function () {
            ...
            var b = [], c, d, e = this.xAxis, f = e && e.getExtremes(),
                g = e ? e.tooltipLen || e.len : this.chart.plotSizeX, h, i, k = [];
    ...
    O(F.prototype, "getTimeTicks", function (a, b, c, d, e, f, g, h) {
    ...
    v(F.prototype, {
        ...
        getExtendedPositions: function () {
            ...
            if (!c[d])f = {
                ...
                }, options: {ordinal: !0}, val2lin: F.prototype.val2lin
    ...
    O(L.prototype, "getSegments", function (a) {
    ...
    var aa = L.prototype, M = Hb.prototype, hc = aa.processData, ic = aa.generatePoints, jc = aa.destroy, kc = M.tooltipHeaderFormatter, lc = {
    ...
    aa.processData = function () {
        ...
        if (hc.apply(this, arguments) !== !1 && d) {
            ...
            if (k) {
                e = !0;
                this.points = null;
                var j = a.getExtremes(), d = j.min, j = j.max, i = i && a.getGroupIntervalFactor(d, j, this) || 1, h = k * (j - d) / h * i, k = a.getTimeTicks(a.normalizeTimeTickInterval(h, c.units || Xb), d, j, null, f, this.closestPointRange), g = aa.groupData.apply(this, [f, g, k, c.approximation]), f = g[0], g = g[1];
                if (c.smoothed) {
                    c = f.length - 1;
    ...
    O(F.prototype, "setScale", function (a) {
        a.call(this);
        q(this.series, function (a) {
            a.hasProcessed = !1
        })
    ...
    M = fa(C.column, {
        ...
        drawPoints: function () {
            ...
            q(a.points, function (j) {
                if (j.plotY !== r)i = j.graphic, c = j.pointAttr[j.selected ? "selected" : ""], f = c["stroke-width"] % 2 / 2, k = s(j.plotX) - f, g = s(j.shapeArgs.width / 2), h = ["M", k, s(j.yBottom), "L", k, s(j.plotY)], j.open !== null && (d = s(j.plotOpen) +
                    f, h.push("M", k, d, "L", k - g, d)), j.close !== null && (e = s(j.plotClose) + f, h.push("M", k, e, "L", k + g, e)), i ? i.animate({d: h}) : j.graphic = b.renderer.path(h).attr(c).add(a.group)
            })
        },
        animate: null
    });
    ...
    M = fa(M, {
        ...
        drawPoints: function () {
            ...
            q(a.points, function (o) {
                m = o.graphic;
                if (o.plotY !== r)c = o.pointAttr[o.selected ? "selected" : ""] || d, j = c["stroke-width"] % 2 / 2, l = s(o.plotX) - j, e = o.plotOpen, f = o.plotClose, g = U.min(e,
                    f), h = U.max(e, f), p = s(o.shapeArgs.width / 2), i = s(g) !== s(o.plotY), k = h !== o.yBottom, g = s(g) + j, h = s(h) + j, n = ["M", l - p, h, "L", l - p, g, "L", l + p, g, "L", l + p, h, "Z", "M", l, g, "L", l, i ? s(o.plotY) : g, "M", l, h, "L", l, k ? s(o.yBottom) : h, "Z"], m ? m.animate({d: n}) : o.graphic = b.renderer.path(n).attr(c).add(a.group).shadow(a.options.shadow)
            })
        }
    });
    C.candlestick = M;
    var qb = ja.prototype.symbols;
    T.flags = y(T.column, {
        dataGrouping: null,
        fillColor: "white",
        lineWidth: 1,
    ...
    v(I, {
        navigator: {
            ...
            series: {
                ...
                compare: null,
                fillOpacity: 0.05,
                dataGrouping: {approximation: "average", enabled: !0, groupPixelWidth: 2, smoothed: !0, units: M},
    ...
    yb.prototype = {
        drawHandle: function (a, b) {
            ...
            var e = this.chart, f = e.renderer, g, h,
                i, k, j = this.scrollbarGroup, l = this.navigatorGroup, m = this.scrollbar, l = this.xAxis, n = this.scrollbarTrack, p = this.scrollbarHeight, q = this.scrollbarEnabled, r = this.navigatorOptions, t = this.scrollbarOptions, x = t.minWidth, v = this.height, y = this.top, A = this.navigatorEnabled, B = r.outlineWidth, C = B / 2, F = 0, D = this.outlineHeight, J = t.barBorderRadius, H = t.barBorderWidth, E = y + C, I;
            if (!isNaN(a)) {
                ...
                c = o(c, l.translate(a));
                d = o(d, l.translate(b));
                if (isNaN(c) || N(c) === Infinity)c = 0, d = k;
            ...
            a.mouseDownHandler = function (d) {
                var d = b.pointer.normalize(d), e = a.zoomedMin, f = a.zoomedMax, h = a.top, k = a.scrollbarHeight, m = a.scrollerLeft, n = a.scrollerWidth, o = a.navigatorLeft, p = a.navigatorWidth, q = a.scrollbarPad, r = a.range, s = d.chartX, t = d.chartY, d = b.xAxis[0], v, w = db ? 10 : 7;
                if (t > h && t < h + g + k)if ((h = !a.scrollbarEnabled || t < h + g) && U.abs(s - e - o) < w)a.grabbedLeft = !0, a.otherHandlePos = f, a.fixedExtreme = d.max, b.fixedRange = null; else if (h && U.abs(s -
            ...
            a.navigatorEnabled ? (a.xAxis = c = new F(b, y({ordinal: m && m.xAxis.options.ordinal},
                f.xAxis, {
                    id: "navigator-x-axis",
                    isX: !0,
                    type: "datetime",
    ...
    P.Scroller = yb;
    O(F.prototype, "zoom", function (a, b, c) {
    ...
    O(L.prototype, "addPoint",
        function (a, b, c, d, e) {
            var f = this.options.turboThreshold;
            f && this.xData.length > f && ea(b) && !Pa(b) && this.chart.scroller && pa(20, !0);
            a.call(this, b, c, d, e)
        });
    v(I, {
        rangeSelector: {
    ...
    zb.prototype = {
        clickButton: function (a, b) {
            ...
            if (!(k === null || j === null || a === c.selected)) {
                if (p === "month" || p === "year")l = {
                    month: "Month",
                    year: "FullYear"
                }[p], n["set" + l](n["get" + l]() - u), l = n.getTime(), k = o(k, Number.MIN_VALUE), isNaN(l) || l < k ? (l = k, m = z(l + i, j)) : i = m - l;
                else if (i)l = w(m - i, k), m = z(l + i, j); else if (p === "ytd")if (h) {
        ...
        computeButtonRange: function (a) {
            ...
            if (d[b])a._range = d[b] * c; else if (b === "month" || b === "year")a._range = {month: 30, year: 365}[b] *
                864E5 * c
        },
        ...
        drawInput: function (a) {
            ...
            this[a + "Label"] = k = e.label(I.lang[h ? "rangeSelectorFrom" : "rangeSelectorTo"],
                this.inputGroup.offset).attr({padding: 2}).css(y(d, f.labelStyle)).add(l);
            l.offset += k.width + 5;
            ...
            this[a + "Input"] = i = Y("input", {name: a, className: "highcharts-range-selector", type: "text"}, v({
                position: "absolute",
                border: 0,
                width: "1px",
                height: "1px",
            ...
            i.onchange = function () {
                ...
                isNaN(d) && (d =
                    a.split("-"), d = Date.UTC(J(d[0]), J(d[1]) - 1, J(d[2])));
                isNaN(d) || (I.global.useUTC || (d += (new Date).getTimezoneOffset() * 6E4), h ? d > b.maxInput.HCTime ? d = r : d < g && (d = g) : d < b.minInput.HCTime ? d = r : d > j && (d = j), d !== r && c.xAxis[0].setExtremes(h ? d : e.min, h ? e.max : d, r, r, {trigger: "rangeSelectorInput"}))
            }
        },
        render: function (a, b) {
            var c = this, d = c.chart, e = d.renderer, f = d.container, g = d.options, h = g.exporting && g.navigation && g.navigation.buttonOptions, i = g.rangeSelector, k = c.buttons, g = I.lang, j = c.div, j = c.inputGroup, l = i.buttonTheme, m = i.inputEnabled !== !1, n = l && l.states, p = d.plotLeft, r;
            if (!c.rendered && (c.zoomText = e.text(g.rangeSelectorZoom, p, d.plotTop - 20).css(i.labelStyle).add(), r = p + c.zoomText.getBBox().width + 5, q(c.buttonOptions, function (a, b) {
                ...
                f), c.inputGroup = j = e.g("input-group").add(), j.offset = 0, c.drawInput("min"), c.drawInput("max");
        ...
        destroy: function () {
            ...
            if (b)b.onfocus = b.onblur = b.onchange =
                null;
    ...
    P.StockChart = function (a, b) {
        ...
        a.xAxis = xa(la(a.xAxis || {}), function (a) {
            return y({
                minPadding: 0,
                maxPadding: 0,
                ordinal: !0,
        ...
        a.yAxis = xa(la(a.yAxis || {}), function (a) {
            d =
                o(a.opposite, !0);
    ...
    O(F.prototype, "autoLabelAlign", function (a) {
    ...
    F.prototype.getPlotLinePath = function (a, b, c, d, e) {
        var f =
            this, g = this.isLinked && !this.series ? this.linkedParent.series : this.series, h = f.chart, i = h.renderer, k = f.left, j = f.top, l, m, n, p, r = [], v, w;
    ...
    F.prototype.getPlotBandPath = function (a, b) {
        ...
        if (d && c)for (f = 0; f < d.length; f +=
            6)e.push("M", d[f + 1], d[f + 2], "L", d[f + 4], d[f + 5], c[f + 4], c[f + 5], c[f + 1], c[f + 2]); else e = null;
        return e
    };
    ja.prototype.crispPolyLine = function (a, b) {
        var c;
        for (c = 0; c < a.length; c += 6)a[c + 1] === a[c + 4] && (a[c + 1] = a[c + 4] = s(a[c + 1]) - b % 2 / 2), a[c + 2] === a[c + 5] && (a[c + 2] = a[c + 5] = s(a[c + 2]) + b % 2 / 2);
        return a
    };
    if (Wa === P.VMLRenderer)gb.prototype.crispPolyLine = ja.prototype.crispPolyLine;
    O(F.prototype, "hideCrosshair", function (a, b) {
        a.call(this, b);
    ...
    O(F.prototype, "drawCrosshair", function (a, b, c) {
        var d, e;
        a.call(this, b, c);
        if (t(this.crosshair.label) && this.crosshair.label.enabled && t(c)) {
            ...
            if (m < k || m > k + this.height)this.hideCrosshair(); else {
                ...
                j.attr({
                    text: n ? Ja(n, {value: c[g]}) : f.formatter.call(this,
                        c[g]), x: l, y: m, visibility: "visible"
                });
                c = j.getBBox();
                if (b) {
    ...
    var mc = aa.init, nc = aa.processData, oc = za.prototype.tooltipFormatter;
    aa.init =
        function () {
    ...
    aa.processData = function () {
        ...
        if (this.xAxis && this.processedYData) {
            ...
            for (d = c.length; a < d; a++)if (typeof c[a] === "number" && b[a] >=
                this.xAxis.min) {
    ...
    O(L.prototype, "render", function (a) {
        if (this.isCartesian)this.clipBox ? this.chart[this.sharedClipKey] && this.chart[this.sharedClipKey].attr({
